...
ADDON_SLUG_MAP = {
    "ai agent":               "addon-ai-agent",
    "lead capture":           "addon-lead-capture",
    "client portal":          "addon-client-portal",
    "advanced dashboard":     "addon-dashboard",
    "custom widget":          "addon-widget",
    "api / external":         "addon-api-integration",
    "api/external":           "addon-api-integration",
    "api integration":        "addon-api-integration",
    "make/n8n":               "addon-workflow-integration",
    "n8n":                    "addon-workflow-integration",
    "make.com":               "addon-workflow-integration",
    "automation & workflow":  "addon-workflow-integration",
    "cross-database":         "addon-automation-cross",
    "cross database":         "addon-automation-cross",
    "automation (cross":      "addon-automation-cross",
    "within database":        "addon-automation-within",
    "within-database":        "addon-automation-within",
