...
const CSS = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  @media print{
    ...
    /* Each .page div is a section — can span multiple physical pages freely */
    .page{margin:0;box-shadow:none;width:100%}
    /* Cover forces page break after; every inner section starts fresh */
    .cover-page{page-break-after:always}
    .inner-page{page-break-before:always}
    @page{margin:0;size:A4}

    /* ── Grid → block: Chromium ignores break-inside on display:grid ── */
    ...
    /* Summary grid: keep 2-col (compact), prevent splitting */
    .summary-grid{
      break-inside:avoid;
      page-break-inside:avoid;
    }
