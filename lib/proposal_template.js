...
const CSS = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  @media print{
    ...
    .module-list,.steps-grid,.phase2-grid,.addon-now-grid,.summary-grid{
      display:block;
    }
    /* Each card gets its own block with margin instead of grid gap */
    ...
    /* Steps were 2-col grid — restore side-by-side feel with inline-block */
    .step-item{
    ...
    /* Keep section blocks together — heading + summary grid on same page */
    .section-block{
      page-break-inside:avoid;
      break-inside:avoid;
    }
    /* Investment table: keep tfoot with tbody */
    .investment-table,.investment-table tfoot,.investment-table tbody tr:last-child{
      page-break-inside:avoid;
      break-inside:avoid;
    }
    /* Addon items: phase2 uses 3-col grid — flatten to block */
    .phase2-item{
      display:grid;
