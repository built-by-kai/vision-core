...
const CSS = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .badge-marketing{background:#1a1a2e;color:#C084FC}
  .badge-team{background:#1a2e1a;color:#7EFF9A}
  .badge-retention{background:#2e1a1a;color:#FF9A7E}
  .badge-agency{background:#0d0d0d;color:var(--lime)}
...
export { renderProposal, mapNotionPayload, getPrefillPayload };
