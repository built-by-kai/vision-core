...
const CSS = `
  *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
  ...
  .badge-operations{background:#162033;color:#7EB8FF}
...
const OS_DEFAULT_MODULES = {
  'Revenue OS':        { 'Revenue OS':        ['CRM & Pipeline', 'Product & Pricing Catalogue', 'Proposal & Deal Tracker', 'Payment Tracker', 'Finance & Expense Tracker'] },
  'Operations OS':     { 'Operations OS':     ['Project Tracker', 'Task Management', 'SOP & Process Library', 'Client Onboarding Tracker', 'Team Responsibility Matrix', 'Retainer Management'] },
  'Business OS':       { 'Revenue OS':        ['CRM & Pipeline', 'Product & Pricing Catalogue', 'Proposal & Deal Tracker', 'Payment Tracker', 'Finance & Expense Tracker'],
                         'Operations OS':     ['Project Tracker', 'Task Management', 'SOP & Process Library', 'Client Onboarding Tracker', 'Team Responsibility Matrix', 'Retainer Management'] },
  'Agency OS':         { 'Revenue OS':        ['CRM & Pipeline', 'Product & Pricing Catalogue', 'Proposal & Deal Tracker', 'Payment Tracker', 'Finance & Expense Tracker'],
                         'Operations OS':     ['Project Tracker', 'Task Management', 'SOP & Process Library', 'Client Onboarding Tracker', 'Team Responsibility Matrix', 'Retainer Management'] },
  'Marketing OS':      { 'Marketing OS':      ['Campaign Tracker', 'Ads Tracker', 'Content Calendar', 'Content Production Tracker', 'Brand & Asset Library'] },
  'People OS':         { 'People OS':         ['Hiring Pipeline', 'Team Onboarding Tracker', 'Performance & Goals', 'Leave & Availability', 'Role & Compensation Log'] },
  'Client Success OS': { 'Client Success OS': ['Client Health Tracker', 'NPS & Feedback Log', 'Renewal Pipeline', 'Upsell Opportunity Tracker', 'Support & Issue Log'] },
};
...
const OS_DEFAULT_ADDONS_LATER = {
  'Revenue OS':        ['Operations OS', 'Marketing OS', 'People OS', 'Client Success OS', 'Document Generation', 'Lead Capture System', 'Agency Command Centre', 'Client Portal View'],
  'Operations OS':     ['Revenue OS', 'Marketing OS', 'People OS', 'Client Success OS', 'Document Generation', 'Lead Capture System', 'Agency Command Centre', 'Client Portal View'],
  'Business OS':       ['Marketing OS', 'People OS', 'Client Success OS', 'Document Generation', 'Lead Capture System', 'Agency Command Centre', 'Ads Live API Integration', 'Client Portal View'],
  'Agency OS':         ['Marketing OS', 'People OS', 'Client Success OS', 'Document Generation', 'Lead Capture System', 'Agency Command Centre', 'Ads Live API Integration', 'Client Portal View'],
  'Marketing OS':      ['Revenue OS', 'People OS', 'Client Success OS', 'Document Generation', 'Lead Capture System', 'Ads Live API Integration', 'Client Portal View'],
  'People OS':         ['Revenue OS', 'Marketing OS', 'Client Success OS', 'Document Generation', 'Employee Dashboard', 'Client Portal View'],
  'Client Success OS': ['Revenue OS', 'Marketing OS', 'People OS', 'Document Generation', 'Lead Capture System', 'Client Portal View'],
};
...
function mapNotionPayload(body) {
  ...
  modules['People OS']         = ppl.length ? ppl : (defaults['People OS']         || []);
  modules['Client Success OS'] = cs.length  ? cs  : (defaults['Client Success OS'] || []);
...
export { renderProposal, mapNotionPayload };
